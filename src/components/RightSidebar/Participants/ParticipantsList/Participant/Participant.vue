...
import { getReadableNumber } from '../../../../../utils/formattedPhoneNumber.js'
...
export default {
	...
	computed: {
		...
		attendeePin() {
			return this.canBeModerated && this.participant.attendeePin ? getReadableNumber(this.participant.attendeePin) : ''
		},
